...
// carta plus
const plusId = 'com.innomatic.cartaplus';
const plusName = 'Carta Plus';
const plusGooglePlay = 'https://play.google.com/store/apps/details?id=$plusId';
